...
const features = [
  {
    name: 'Secure Storage',
    description: 'Files are encrypted and stored securely on IPFS and Ethereum blockchain.',
    icon: LockClosedIcon,
  },
  {
    name: 'Decentralized',
    description: 'No single point of failure, data is distributed across the network.',
    icon: GlobeAltIcon,
  },
  {
    name: 'Privacy Focused',
    description: 'You control who can access your files with cryptographic permissions.',
  ...
  return (
    <div className="isolate">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                ...
                <span className="mt-2 block bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Blockchain Technology</span>
              </h1>
              
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Upload, store, and share your files with unbreakable security using decentralized technology 
                <span className="block mt-2">Powered by Ethereum and IPFS for maximum protection and accessibility.</span>
              </p>
            ...
            <div className="mt-24 lg:mt-32 relative">
              ...
              <div className="relative flex justify-center">
                <span className="bg-gray-900 px-4 text-2xl font-semibold text-indigo-400">Why Choose Blockchain Storage</span>
              </div>
              ...
              <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2">
                <div className="relative backdrop-blur-sm bg-gray-900/40 rounded-3xl p-8 shadow-xl ring-1 ring-gray-800 overflow-hidden">
                  ...
                  <p className="mt-3 text-gray-400">
                    Traditional cloud storage solutions are vulnerable to data breaches and unauthorized access. Blockchain storage distributes your data across a secure network making it virtually impossible to compromise.
                  </p>
                ...
                <div className="relative backdrop-blur-sm bg-gray-900/40 rounded-3xl p-8 shadow-xl ring-1 ring-gray-800 overflow-hidden">
                  ...
                  <p className="mt-3 text-gray-400">
                    With blockchain storage, you retain complete control over your data. No central authority can restrict access or change permissions without your cryptographic approval.
                  </p>
                  <ul className="mt-6 space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -inset-x-2 -top-2 bottom-0">
                    <svg className="absolute left-0 top-0 h-24 w-24 -translate-x-1/3 -translate-y-1/3 transform fill-indigo-500/20" viewBox="0 0 64 64" aria-hidden="true">
                      <path d="M63.71 30.935a32.003 32.003 0 0 1-45.298 27.02C6.628 52.7 0 41.45 0 29.883 0 13.455 13.286.22 29.714.22c15.977 0 29.068 12.747 29.425 28.724l4.828-.355A1 1 0 0 1 65 29.58v.072a1 1 0 0 1-.93 1.013l-4.353.318a1 1 0 0 0-.934 1.035 1 1 0 0 0 1.002.982l3.925.041z" />
                    </svg>
                    <svg className="absolute right-0 bottom-0 h-24 w-24 translate-x-1/3 translate-y-1/3 transform fill-purple-500/20" viewBox="0 0 64 64" aria-hidden="true">
                      <path d="M62.399 54.71a32.003 32.003 0 0 1-28.924 9.298C21.782 61.325 12.075 52.975 8.035 42.08c-6.405-17.27 2.352-36.308 19.622-42.713C45.203-6.698 63.565 2.779 69.38 19.976l-5.976 2.196a1 1 0 0 1-1.317-.518l-.026-.067a1 1 0 0 1 .546-1.314l4.694-1.714a1 1 0 0 0 .58-1.288 1 1 0 0 0-1.288-.58l-3.67 1.34z" />
                    </svg>
                  </div>
                  ...
                  <div className="relative w-full max-w-2xl mx-auto">
                    <div className="text-center mb-8">
                      ...
                      <p className="mt-2 text-gray-400">Your files will be securely stored on the blockchain network</p>
                    </div>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center">
          <span className="bg-gray-900 px-4 text-2xl font-semibold text-indigo-400">Your Blockchain Files</span>
        </div>
      </div>
